...
export const NOTICE_FOR_REGISTRATION_TOURNAMENT = "NOTICE !! SELECT YOUR TEAM NAME AND THE REST OF YOUR INFORMATION WILL FILL IN AUTOMATICALLY. IF ALL YOUR INFORMATION IS NOT LISTED OR YOU NEED TO CHANGE YOUR INFORMATION, PLEASE ADD OR MAKE THE CHANGES BEFORE SUBMIITING THIS FORM. THEN THE NEXT TIME YOU REGISTER FOR A GSA TOURNAMENT YOUR INFORMATION WILL FILL IN CORRECTLY";
